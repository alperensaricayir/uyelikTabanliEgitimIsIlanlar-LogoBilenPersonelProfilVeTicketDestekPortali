...
@section('title', 'Silinen Dersler – ' . $course->title)
...
@section('content')
    <div class="space-y-4">
        <div class="flex items-center gap-3">
            ...
            <div>
                <h2 class="text-2xl font-bold text-gray-900">Silinen Dersler</h2>
        ...
        <div class="bg-white rounded-xl border border-gray-200 overflow-hidden">
            @if($lessons->isEmpty())
                <div class="p-10 text-center text-gray-400">
                    ...
                    <p class="text-sm">Silinmiş ders bulunmuyor.</p>
                </div>
            @else
                    ...
                    <tbody class="divide-y divide-gray-100">
                        @foreach($lessons as $lesson)
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-4 py-3 text-gray-500">{{ $lesson->deleted_at->format('d.m.Y H:i') }}</td>
                                <td class="px-4 py-3 text-right">
                                    <form method="POST" action="{{ route('cms.courses.lessons.restore', [$course, $lesson->id]) }}">
                                        @csrf
                                        <button
