<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">Discover – Öne Çıkanlar</h2>
    </x-slot>
    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="space-y-4">
                    ...
                    <div class="bg-white shadow rounded-lg p-5 flex items-center justify-between">
                            ...
                            <div>
                                ...
                                <div class="flex items-center gap-2 text-xs text-gray-500 mt-1">
                                    @if($member->is_premium)
                                        <span class="bg-amber-100 text-amber-700 px-1.5 py-0.5 rounded">⭐ Premium</span>
                                    @endif
                                    @if($member->featured_links)
                                        <span class="bg-indigo-100 text-indigo-600 px-1.5 py-0.5 rounded">🔗 Featured</span>
                                    @endif
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <div class="text-center">
                                ...
                                <p class="text-xs text-gray-400">Puan</p>
                            </div>
                ...
                @empty
                    <p class="text-center text-gray-400 py-12">Henüz üye bulunmuyor.</p>
                @endforelse
            </div>
