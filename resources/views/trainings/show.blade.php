        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white shadow rounded-lg p-8">
                ...
                @if($training->is_premium_only)
                    <span
                        class="inline-block mb-4 text-xs font-semibold bg-amber-100 text-amber-700 px-3 py-1 rounded-full">
                        ⭐ Premium Eğitim
                    </span>
                @endif

                <p class="text-gray-700 mb-8 leading-relaxed">{{ $training->description }}</p>

                {{-- GATED CONTENT --}}
                @if($training->meeting_url || $training->resources_url)
                    <div class="border-t pt-6">
                        <h3 class="font-semibold text-gray-800 mb-4">📎 Eğitim Materyalleri</h3>
                        ...
                        @else
                            ...
                            <div class="bg-gray-50 border border-dashed border-gray-300 rounded-lg p-6 text-center">
                                ...
                                <p class="text-gray-600 font-medium mb-2">Bu içerik Premium üyelere özeldir.</p>
                                <p class="text-gray-500 text-sm">Eğitim linki ve kaynaklara erişmek için Premium üyeliğe
                                    ihtiyacınız var.</p>
                                @guest
                                    <a href="{{ route('login') }}"
