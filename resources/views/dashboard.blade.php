<x-app-layout>
    ...
    <div class="min-h-screen bg-neutral-50 dark:bg-gray-950">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-5 gap-6">
                ...
                <div
                    ...
                    <div
                        ...
                        <div class="flex items-center gap-2">
                            <div
                                class="w-6 h-6 rounded-md bg-emerald-100 dark:bg-emerald-900/40 flex items-center justify-center">
                            ...
                            <h2 class="font-semibold text-neutral-900 dark:text-gray-100 text-sm">Destek Ticket'larım
                            </h2>
                        </div>
                        <a href="{{ route('tickets.index') }}"
                    ...
                    @if($openTickets->isEmpty())
                        <div class="flex-1 py-10 px-6 text-center flex flex-col items-center justify-center">
                            <div class="w-12 h-12 rounded-full bg-emerald-50 flex items-center justify-center mb-3">
                                <svg class="w-6 h-6 text-emerald-400 dark:text-emerald-500" fill="none"
                                    stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
                    ...
                    @else
                        ...
                        <div
                            class="px-6 py-3 bg-neutral-50 dark:bg-gray-800/30 border-t border-neutral-100 dark:border-gray-800">
                            <a href="{{ route('tickets.create') }}"
                                class="text-xs font-semibold text-emerald-600 dark:text-emerald-400 hover:text-emerald-800 dark:hover:text-emerald-300 transition-colors">
                                + Destek Ticket'ı Oluştur
                            </a>
            ...
            {{-- ── QUICK ACTIONS ───────────────────────────── --}}
            <div
                class="bg-white dark:bg-gray-900 rounded-2xl border border-neutral-200 dark:border-gray-700 shadow-sm p-6">
                ...
                <div class="grid grid-cols-3 sm:grid-cols-6 gap-3">
                    ...
                    <a href="{{ route('trainings.index') }}"
                        ...
                        <span
                            class="text-xs font-semibold text-violet-700 dark:text-violet-400 text-center leading-tight">Eğitimler</span>
                    </a>
                    ...
                    <a href="{{ route('tickets.create') }}"
                        ...
                        <span
                            class="text-xs font-semibold text-emerald-700 dark:text-emerald-400 text-center leading-tight">Destek
                            Ticket'ı</span>
                    </a>
                    ...
                    <a href="{{ route('discover.index') }}"
                        ...
                        <div
                            class="w-10 h-10 rounded-xl bg-white dark:bg-gray-800 shadow-sm flex items-center justify-center group-hover:shadow transition-shadow">
                            <svg class="w-5 h-5 text-fuchsia-600 dark:text-fuchsia-400" fill="none"
                                stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <span
                            class="text-xs font-semibold text-fuchsia-700 dark:text-fuchsia-400 text-center leading-tight">Keşfet</span>
                    </a>
                    ...
                    @if(auth()->user()->isPremium())
                        <button type="button" onclick="window.dispatchEvent(new CustomEvent('open-premium-modal'))"
                            ...
                            <span
                                class="text-xs font-semibold text-amber-700 dark:text-amber-400 text-center leading-tight">Premium</span>
                        </button>
                    @else
                        <button type="button" onclick="window.dispatchEvent(new CustomEvent('open-premium-modal'))"
                            class="flex flex-col items-center gap-2 py-5 px-3 rounded-xl bg-neutral-50 dark:bg-gray-800 border border-neutral-200 dark:border-gray-700 opacity-80 hover:bg-amber-50 dark:hover:bg-amber-900/20 transition-all">
                            <div
                                class="w-10 h-10 rounded-xl bg-white dark:bg-gray-900 shadow-sm flex items-center justify-center">
                                <svg class="w-5 h-5 text-neutral-400 dark:text-gray-500" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <span
                                class="text-xs font-semibold text-neutral-500 dark:text-gray-400 text-center leading-tight">Premium
                                Ol</span>
                        </button>
                    @endif
